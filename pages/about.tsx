...
export default function About() {
  return (
    <div className="bg-[#EDF3F8]">
      <div>
        <NavBar />
        <div className="text-center mx-6 md:mx-10 mt-12 md:mt-[80px]">
          <h1 className="text-[#36536B] font-display text-[32px] leading-9 mb-10 md:text-[48px] md:leading-[56px] md:mb-[54px]">
            We empower innovators by delivering access to the financial system
          </h1>
          <div className="mb-12 md:mb-[64px] md:flex md:justify-center md:gab-[10px]">
            <h4 className="text-[#36536B] font-display text-[24px] md:text-[32px] mb-4 leading-8 md:leading-[40px] md:w-[223px]">
              Our Vision
            </h4>
            <p className="text-[#6C8294] font-public text-[15px] leading-7 md:w-[456px] md:text-justify">
          ...
          <div className="mb-[76px] md:mb-[92px] md:flex md:justify-center md:gab-[10px]">
            <h4 className="text-[#36536B] font-display text-[24px] md:text-[32px] mb-4 leading-8 md:leading-[40px] md:w-[223px]">
              Our Business
            </h4>
            <p className="text-[#6C8294] font-public text-[15px] leading-7 md:w-[456px] md:text-justify">
        ...
        <div className="text-center md:flex md:justify-between md:items-end md:mx-10 md:my-[64px]">
